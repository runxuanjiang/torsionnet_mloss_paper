...
\section{\titleofpaper \space Architecture}
  A visual representation of the architecture can be seen in figure \tarun{overall thoughts: we should describe more of the specific utils and conformer generation conveniences that we created, such as the molecule observation environments, or the reward counting via built in conformer rejection. As it stands most of the components we discuss here are not unique to our library.} \ref{fig:architecture}.
