...
Additionally, \code{\titleofpaper} provides extensive logging capabilities and an analysis module for recording and visualizing training results, including conformer-generation specific metrics and visuals. \ambuj{I think we can add some visuals, especially of molecules, to the paper to make this point more forcefully} \paul{seconding this comment}
